...
execute if score #rabbitduck_roll operator matches 0 run title @a[scores={rabbitduck_prompt=2}] actionbar {text:"You are the Impostor! You must guess the prompt!",color:red}
